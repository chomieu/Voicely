...
function voiceSearch( matchText, emojiObject ) {
    ...
    if ( matchArray && emojiObject ) {
        ...
        for ( var i = 0; i < matchArray.length; i++ ) {
            ...
            // - The substring() method call removes the first speech tag by removing everything BEFORE the SECOND instance of whitespace, and removing everything AFTER the LAST instance of whitespace.
            ...
            console.log( "6. Matched string stripped of symbol words and commas: ", strippedString );
